 ...
 * @author moviles
 */
public class Eval3_1_ORDENAMIENTO {
    ...
    private static void quickSortRec( int[] arreglo, int ini, int fin){
        //pivote --> posicion
        //dos indices:
        //ind_gran --> busca a los mayores al pivote
        //int_peq --> busca los menores al pivote
        //si se encuentran valores, se intercambian
        //si se cruzan, se intercambia el pivote con el ind_peq
